# here we will do model training and experiment tracking
import os
import sys
import joblib
import pandas as pd
...
class ModelTraining:
    ...
    def load_and_split_data(self):
        try: 
            ...
            logger.info("Data successfully splitted for model trainig")

            return x_train,x_test,y_test,y_train
        
        except Exception as e:
            logger.error(f"error during loading the data {e}")
    ...
    def train_lgbm(self,x_train,y_train):
        try:
            ...
            logger.info("starting our model trainig")
            ...
            logger.error(f"error while trainig model {e}")
    ...
    def evaluate_model(self,model,x_test,y_test) :
        try:
            ...
            logger.info(f"Accuuracy Score:{accuracy}")
    ...
    def run(self):
        try:
            with mlflow.start_run():
                ...
                logger.info(" starting MLFLOW ecxperimentation ")
                ...
                x_train,x_test,y_test,y_train=self.load_and_split_data()
